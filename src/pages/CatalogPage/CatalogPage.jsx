            ...
            <div className="content">
                ...
                <div className="categories">
                    ...
                    <div className="categories_btn">
                        ...
                        <button onClick={() => setCategory(1)} className="btn">Базовые</button>
                        <button onClick={() => setCategory(2)} className="btn">На молнии</button>
                        <button onClick={() => setCategory(3)} className="btn">С принтами</button>
                    </div>
                </div>
                ...
                <div className="catalog-items">
                    {
                        sortedFilteredTovars.length ?
                            sortedFilteredTovars.map((tovar) => {
                                return (
                                    <Item id={tovar.id} image={tovar.image} name={tovar.name} text={tovar.text} price={tovar.price} count={tovar.count} size={tovar.size}/>
                                )
                            })
                            :
